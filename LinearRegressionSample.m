function [ params, time, gradient_value, error_bound, cc ] = LinearRegressionSample( ftr, lbl, sample_rate, lambda, probablity )
  ...
  [ error_bound, cc ] = LinearRegressionSampleError(fsample, lsample, params, lambda, probablity);
end
