...
if do_logistic
  ...
  [logistic_prediction_errors_full_model, logistic_prediction_errors_truth, logistic_model_errors] = LogisticEmpiricalErrors(logistic_full_params, logistic_params, trainf, trainl);
...
if do_linear
  ...
  [linear_prediction_errors_full_model, linear_prediction_errors_truth, linear_model_errors] = LinearEmpiricalErrors(linear_full_params, linear_params, trainf, trainl);
