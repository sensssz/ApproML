...
PlotPredictionError(sampling_rates, logistic_prediction_errors_full_model, 'Ground Truth', 'logistic_ground_truth');
PlotPredictionError(sampling_rates, linear_prediction_errors_full_model, 'Full Model', 'linear_full_model');
PlotPredictionError(sampling_rates, linear_prediction_errors_full_model, 'Ground Truth', 'linear_ground_truth');
